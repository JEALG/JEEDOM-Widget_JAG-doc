...
<blockquote>
    ...
    <ul>
        ...
        <li><b>Pour avoir le paramétrage par défaut du widget Detection Mouvement, il faudra ajouter pour avoir le logo par défaut de ce widget </b> :</li>
        <ul>
...
<p><img src="../../img/RESULTAT_JEEDOM_Detection_Mouvement.png" alt="Resultat" /></p>
<blockquote>
...
<blockquote>
        <ul>
            <li><b>logoON</b> : Permet de choisir l'image pour la valeur ON ou OFF <i>(valeur par défaut : al_mouv_off)</i></li>
            <li><b>logoON_type</b> : Permet de choisir <i>l'extension</i> pour l'icône/image <i>logoON</i> (par exemple: 'gif', 'jpg', etc.....)<i>(valeur par défaut : png)</i></li>
            <li><b>logoON</b> : Permet de choisir l'image pour la valeur ON ou OFF <i>(valeur par défaut : al_mouv_on)</i></li>
...
<hr />
<dl>
    <a href="https://github.com/JEALG/JEEDOM-Detection-Mouvement/commits/master">Changelog WIDGET</a><br/>

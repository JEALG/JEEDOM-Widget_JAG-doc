...
<blockquote>
        <ul>
            <li><b>logo-M</b> : Permet de choisir l'image pour la valeur ON ou OFF <i>(valeur par défaut : la_ampoule)</i></li>
...
<hr />
<dl>
    <a href="https://github.com/JEALG/JEEDOM-Lampe--mobile/commits/master">Changelog WIDGET</a><br/>
